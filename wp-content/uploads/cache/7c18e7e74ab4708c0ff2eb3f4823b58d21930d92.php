...
<section data-<?php echo e($block['id']); ?> class="<?php echo e($block['classes']); ?> gradient-light block-latest-publications">
  <div class="pad">
    <div class="container">
      ...
      <div class="view-all">
        <a class="btn btn-right btn-gradient" href="<?php echo get_permalink(2172); ?>"><span>View all<i></i></span></a>
      </div>
    </div>
  </div>
</section>
